...
int main( )
{
    auto *pM1 = Message( "selan@dimap.ufrn.br", "LP1", "201509011355", "jack@gmail.com", "jack.boy@hotmail.com", "false", "Aqui começa o corpo da mensagem\n Queremos voce por aqui.\n \n Ate breve!" );
    auto *pM2 = Message( "andre@gmail.com", "Qualquer coisa", "201509101255" );
    auto *pM3 = Message( "silvia.mota@hotmail.com", "Pesquisa em conjunto", "201509101055" );
